...
module.exports = async () => {
    ...
    console.log("Gnosis Safe deployed to:", gnosisSafe.address);
    ...
    console.log("Gnosis Safe Multisig implementation deployed to:", gnosisSafeMultisig.address);
    ...
    console.log("Gnosis Safe Multisig implementation with same address deployed to:", gnosisSafeSameAddressMultisig.address);
    ...
    // Send some ether to the testAddress1
    ...
    let initDeployJSON = {
        ...
        "OLAS": olas.address,
        "DAI": dai.address,
        "PAIR": pairODAI.address,
        "veOLAS": ve.address,
        "wveOLAS": wve.address,
        "timelock": timelock.address,
        "GovernorOLA": governor.address,
        "buOLAS": bu.address,
        "donatorBlacklist": donatorBlacklist.address,
        "tokenomicsProxy": tokenomics.address,
        "treasury": treasury.address,
        "genericBondCalculator": genericBondCalculator.address,
        "depository": depository.address,
        "dispenser": dispenser.address,
        "Gnosis Safe": gnosisSafe.address,
        "Gnosis Safe Proxy Factory": gnosisSafeProxyFactory.address,
        ...
        "Gnosis Safe MultiSend": multiSend,
